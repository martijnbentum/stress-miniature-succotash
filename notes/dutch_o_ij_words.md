...
Extracted different layers from the model cnn, tf layer 11 & tf layer 21 

based on different segments:
onset, vowel, rime, coda, syllable and word (word should be the same as syllable)

Word list (max set to 100, there many more 'zijn' tokens)
